...
public class MessagesListAdapter extends ArrayAdapter<DroidconUpdatesMessage> {
	...
	public MessagesListAdapter(Context context, int listViewResource,
			List<DroidconUpdatesMessage> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DroidconUpdatesMessage message = getItem(position);
